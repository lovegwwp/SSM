...
<html>
	<head>
	 ...
	 <script type="text/javascript"> 
      ...
      function rePatOnFlash(){
         //reload:重新执行url，condition是url中的参数  
            $("#searchPatOnFm").form("clear");  
            //$('#dg').datagrid("reload");  
             $("#patOnDg").datagrid({
	           url:"patOnTjCx.action"      	     
	         });         
        }
      function doPatOnSearch(){
     ...
     function compute(colName) {
          var rows = $("#patOnDg").datagrid("getRows");
          var total = 0;
	...
	<body class="easyui-layout">
		<table id="patOnDg" title="康复者在线区域统计" class="easyui-datagrid" style="width:1750px;height:865px"
			url="patOnTjCx.action"
		...
		<div id="toolbar" style="padding:3px">
		    ...
		    <div style="padding:5px">
		        <form id="searchPatOnFm">  
					...
					<a href="#" class="easyui-linkbutton" iconCls="icon-search"  onclick="doPatOnSearch()">搜索</a>&nbsp;&nbsp;					
					<a href="#" class="easyui-linkbutton" iconCls="icon-reload"  onclick="rePatOnFlash()">刷新</a>
				 </form>
			</div>
		</div>
