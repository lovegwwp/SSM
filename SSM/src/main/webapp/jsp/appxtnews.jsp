...
<html>
    ...
    function saveXtNews(){
	    ...
	    //if(checkFileExt(fValue)){
	    	 commonSaveUpload(fm,"${pageContext.request.contextPath}/addAPPXtNews.action",addWin,grid);  
      	 //}else{
	...
	<body class="easyui-layout">
       ...
       <div id="addXtNews" class="easyui-window" title="新增消息"  closed = "true" style="width:500px;height:300px;">
