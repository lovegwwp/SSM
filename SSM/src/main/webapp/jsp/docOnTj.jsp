...
<html>
	<head>
	 ...
	 <script type="text/javascript"> 
      ...
      function redocOnFlash(){
         //reload:重新执行url，condition是url中的参数  
            $("#searchdocOnFm").form("clear");  
            //$('#dg').datagrid("reload");  
             $("#docOnDg").datagrid({
	           url:"docOnTjCx.action"      	     
	         });         
        }
      function dodocOnSearch(){
     ...
     function compute(colName) {
          var rows = $("#docOnDg").datagrid("getRows");
          var total = 0;
	...
	<body class="easyui-layout">
		<table id="docOnDg" title="医生在线区域统计" class="easyui-datagrid" style="width:1750px;height:865px"
			url="docOnTjCx.action"
		...
		<div id="toolbar" style="padding:3px">
		    ...
		    <div style="padding:5px">
		        <form id="searchdocOnFm">  
					...
					<a href="#" class="easyui-linkbutton" iconCls="icon-search"  onclick="dodocOnSearch()">搜索</a>&nbsp;&nbsp;					
					<a href="#" class="easyui-linkbutton" iconCls="icon-reload"  onclick="redocOnFlash()">刷新</a>
				 </form>
			</div>
		</div>
