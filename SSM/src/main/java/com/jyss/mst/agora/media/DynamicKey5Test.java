...
public class DynamicKey5Test {
	...
	public void testGeneratePublicSharingKey() throws Exception {
		...
		String result = DynamicKey5.generatePublicSharingKey(appID,
				appCertificate, channel, ts, r, uid, expiredTs);
	...
	public void testGenerateRecordingKey() throws Exception {
		...
		String result = DynamicKey5.generateRecordingKey(appID, appCertificate,
	...
	public void testGenerateMediaChannelKey() throws Exception {
		...
		String result = DynamicKey5.generateMediaChannelKey(appID,
				appCertificate, channel, ts, r, uid, expiredTs);
		assertEquals(expected, result);
	}
	...
	public void testInChannelPermission() throws Exception {
		...
		String generatedNoUpload = DynamicKey5.generateInChannelPermissionKey(
				appID, appCertificate, channel, ts, r, uid, expiredTs,
		...
		String generatedAudioVideoUpload = DynamicKey5
				.generateInChannelPermissionKey(appID, appCertificate, channel,
						ts, r, uid, expiredTs, DynamicKey5.audioVideoUpload);
