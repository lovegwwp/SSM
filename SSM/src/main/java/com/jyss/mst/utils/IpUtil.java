...
public class IpUtil {
	...
	public static String getAddrByIp(String macIp) {
		String re = "";
		try {
			String addr = getAddresses("ip=" + macIp, "utf-8");
			JSONObject jsonObj = JSON.parseObject(addr);
			Map<String, Object> objMap = new HashMap<String, Object>();
			objMap = JSON.toJavaObject(jsonObj, Map.class);
			Map<String, String> strMap = new HashMap<String, String>();
			strMap = (Map<String, String>) objMap.get("data");
			re = strMap.get("isp") + "-" + strMap.get("country")
					+ strMap.get("area") + strMap.get("region")
					+ strMap.get("city") + strMap.get("county");
	...
	public static void main(String[] args) {
		...
		// 测试ip 219.136.134.157 中国=华南=广东省=广州市=越秀区=电信122.49.20.247
		...
		JSONObject jsonObj = JSON.parseObject(address);
		Map<String, Object> objMap = new HashMap<String, Object>();
		objMap = JSON.toJavaObject(jsonObj, Map.class);
		Map<String, String> strMap = new HashMap<String, String>();
		strMap = (Map<String, String>) objMap.get("data");
		System.out.println(strMap.get("isp") + "-" + strMap.get("country")
				+ strMap.get("area") + strMap.get("region")
				+ strMap.get("city") + strMap.get("county"));
